...
// Ícone da caneca (SVG minimalista)
const cupIcon = `data:image/svg+xml,${encodeURIComponent(`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32">
  <circle cx="16" cy="16" r="15" fill="#2c3e50"/>
  <path d="M10 12h8v10a2 2 0 01-2 2h-4a2 2 0 01-2-2V12z" fill="#ecf0f1"/>
  <path d="M18 14h2a1 1 0 011 1v2a1 1 0 01-1 1h-2v-4z" fill="#bdc3c7"/>
  <rect x="12" y="10" width="4" height="1" fill="#95a5a6"/>
</svg>
`)}`;

document.querySelector("link[rel~='icon']").href = cupIcon;
...
async function showSplashScreen() { 
    ...
    splashScreen.innerHTML = `
        <div style="margin-bottom: 40px;">
            <span style="color:white;">KHANECO</span><span style="color:#72ff72;">.SPACE</span>
        </div>
        <div style="font-size: 14px; color: #888; line-height: 1.6; text-align: center;">
            <div style="margin-bottom: 10px;">☕ Baseado em KhanWare</div>
            <div>👨‍💻 Desenvolvido por <span style="color: #72ff72;">m4nst3in</span></div>
        </div>
    `; 
...
/* Credits Footer */
function createCreditsFooter() {
    const footer = document.createElement('div');
    footer.id = 'khaneco-credits';
    ...
    footer.innerHTML = `
        <div style="display: flex; align-items: center; gap: 6px;">
            ...
            <span>Khaneco by <span style="color: #72ff72;">m4nst3in</span></span>
        </div>
    `;
    ...
    // Click to show full credits
    footer.addEventListener('click', () => {
        sendToast(`
            ☕ Khaneco - Ferramenta educacional
            🔧 Baseado em KhanWare
